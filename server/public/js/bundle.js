    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alerts.showAlert)('error', 'Invalid login credentials. Please retry!');
        case 12:
        case "end":
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, passwordConfirm, role) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log('Attempting to sign up with:', name, email, password, passwordConfirm, role);
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 4:
          ...
          if (res.data) {
            (0, _alerts.showAlert)('success', 'Account created successfully! Please log in.');
            window.setTimeout(function () {
        ...
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](1);
          (0, _alerts.showAlert)('error', 'Please verify the information entered.');
        case 12:
        case "end":
          return _context.stop();
      }
...
exports.updateRoomData = exports.updateData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var updateRoomData = exports.updateRoomData = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, name, price, desc, status) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/room/".concat(room.id),
            data: {
              name: name,
              price: price,
              desc: desc,
  ...
  return function updateRoomData(_x3, _x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
if (roomDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
